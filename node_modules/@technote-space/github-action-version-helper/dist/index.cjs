...
var githubActionHelper = require('@technote-space/github-action-helper');
...
var constant = /*#__PURE__*/Object.freeze({
    __proto__: null,
    MERGE_MESSAGE_PATTERN: MERGE_MESSAGE_PATTERN,
    SEMANTIC_MESSAGE_PATTERN: SEMANTIC_MESSAGE_PATTERN,
...
const getCommits = async (types, excludeMessages, breakingChangeNotes, octokit, context) => (await listCommits(octokit, context))
    ...
    .map(item => ({
    sha: githubActionHelper.Utils.ensureNotNull(item.commit.sha),
    ...item.message,
}));
...
const getNextVersion = async (minorUpdateCommitTypes, excludeMessages, breakingChangeNotes, helper, octokit, context, logger) => {
    ...
    const next = githubActionHelper.Utils.generateNewVersion(current, getNextVersionLevel(minorUpdateCommitTypes, commits));
